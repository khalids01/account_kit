defmodule Accountkit.Accounts.User do
  use Ash.Resource,
    otp_app: :accountkit,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Accountkit.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Accountkit.Accounts.Token
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Accountkit.Accounts.User.Senders.SendPasswordResetEmail
      ...
      magic_link do
        ...
        sender Accountkit.Accounts.User.Senders.SendMagicLinkEmail
      end
