defmodule AccountkitWeb.Components.Sections.Footer do
  @moduledoc """
  The `AccountkitWeb.Components.Sections.Footer` module provides a customizable footer component for Phoenix applications,
