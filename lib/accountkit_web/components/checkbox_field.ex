defmodule AccountkitWeb.Components.CheckboxField do
  @moduledoc """
  AccountkitWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
