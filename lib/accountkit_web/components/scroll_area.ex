defmodule AccountkitWeb.Components.ScrollArea do
  @moduledoc """
  The `AccountkitWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
