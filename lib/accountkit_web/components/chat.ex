defmodule AccountkitWeb.Components.Chat do
  @moduledoc """
  `AccountkitWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
