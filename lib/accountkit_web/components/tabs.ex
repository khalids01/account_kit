defmodule AccountkitWeb.Components.Tabs do
  @moduledoc """
  `AccountkitWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import AccountkitWeb.Components.Badge, only: [badge: 1]
