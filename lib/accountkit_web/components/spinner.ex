defmodule AccountkitWeb.Components.Spinner do
  @moduledoc """
  The `AccountkitWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `AccountkitWeb.Components.Spinner` module enables developers to provide
