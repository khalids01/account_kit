defmodule AccountkitWeb.Components.Image do
  @moduledoc """
  The `AccountkitWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
