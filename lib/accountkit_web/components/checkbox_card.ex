defmodule AccountkitWeb.Components.CheckboxCard do
  @moduledoc """
  The `AccountkitWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
