defmodule AccountkitWeb.Components.Stepper do
  @moduledoc """
  The `AccountkitWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `AccountkitWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
