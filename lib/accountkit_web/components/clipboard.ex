defmodule AccountkitWeb.Components.Clipboard do
  @moduledoc """
  The `AccountkitWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
