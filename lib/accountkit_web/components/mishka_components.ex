defmodule AccountkitWeb.Components.MishkaComponents do
  defmacro __using__(_) do
    quote do
      import AccountkitWeb.Components.Accordion, only: [accordion: 1]
      ...
      import AccountkitWeb.Components.Carousel, only: [carousel: 1]
      import AccountkitWeb.Components.Chat, only: [chat: 1, chat_section: 1]

      import AccountkitWeb.Components.CheckboxCard,
        only: [checkbox_card: 1, checkbox_card_check: 3]

      import AccountkitWeb.Components.CheckboxField,
        only: [checkbox_field: 1, group_checkbox: 1, checkbox_check: 3]

      import AccountkitWeb.Components.Clipboard, only: [clipboard: 1]
      import AccountkitWeb.Components.Collapse, only: [collapse: 1]
      import AccountkitWeb.Components.ColorField, only: [color_field: 1]
      import AccountkitWeb.Components.Combobox, only: [combobox: 1]
      import AccountkitWeb.Components.DateTimeField, only: [date_time_field: 1]
      ...
      import AccountkitWeb.Components.NumberField, only: [number_field: 1]
      import AccountkitWeb.Components.Overlay, only: [overlay: 1]
      import AccountkitWeb.Components.Pagination, only: [pagination: 1]
      import AccountkitWeb.Components.PasswordField, only: [password_field: 1]
      import AccountkitWeb.Components.Popover, only: [popover: 1]

      import AccountkitWeb.Components.Progress,
        only: [progress: 1, progress_section: 1, semi_circle_progress: 1, ring_progress: 1]

      import AccountkitWeb.Components.RadioCard, only: [radio_card: 1, radio_card_check: 3]

      import AccountkitWeb.Components.RadioField,
        only: [radio_field: 1, group_radio: 1, radio_check: 3]

      import AccountkitWeb.Components.RangeField, only: [range_field: 1]
      import AccountkitWeb.Components.Rating, only: [rating: 1]
      import AccountkitWeb.Components.ScrollArea, only: [scroll_area: 1]
      import AccountkitWeb.Components.SearchField, only: [search_field: 1]
      import AccountkitWeb.Components.Sidebar, only: [sidebar: 1]
      import AccountkitWeb.Components.Skeleton, only: [skeleton: 1]
      ...
      import AccountkitWeb.Components.TextField, only: [text_field: 1]
      import AccountkitWeb.Components.TextareaField, only: [textarea_field: 1]
      import AccountkitWeb.Components.Timeline, only: [timeline: 1, timeline_section: 1]

      import AccountkitWeb.Components.Toast,
        only: [
          toast: 1,
          toast_group: 1,
          show_toast: 1,
      ...
      import AccountkitWeb.Components.ToggleField, only: [toggle_field: 1, toggle_check: 2]
      import AccountkitWeb.Components.Tooltip, only: [tooltip: 1]

      import AccountkitWeb.Components.Typography,
        only: [
          h1: 1,
          h2: 1,
          h3: 1,
      ...
      import AccountkitWeb.Components.UrlField, only: [url_field: 1]
      import AccountkitWeb.Components.Video, only: [video: 1]
    end
  end
end
