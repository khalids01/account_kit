defmodule AccountkitWeb.Components.Menu do
  @moduledoc """
  The `AccountkitWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `AccountkitWeb.Components.Menu` is ideal for creating multi-level navigation menus in
