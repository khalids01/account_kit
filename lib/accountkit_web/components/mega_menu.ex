defmodule AccountkitWeb.Components.MegaMenu do
  @moduledoc """
  The `AccountkitWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
