defmodule AccountkitWeb.Components.Overlay do
  @moduledoc """
  The `AccountkitWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `AccountkitWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
