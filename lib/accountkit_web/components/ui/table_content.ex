defmodule AccountkitWeb.Components.UI.TableContent do
  @moduledoc """
  `AccountkitWeb.Components.UI.TableContent` is a component module designed to create flexible and dynamic
